...
describe("strict-tool-arrays tests", () => {
  ...
  it("entry detection decodes to real array", () => {
    assert(entryCoerced.success, 'entry detection accepts string-encoded array');
  ...
  it("strict start schema decodes to real array", () => {
    assert(startCoerced.success, 'strict start schema accepts string-encoded CT array');
