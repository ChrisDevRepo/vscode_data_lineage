...
// NOTE: the probe used kind:'routed' here (not a valid InvestigationTask kind — it was `as any`).
...
// F-05 (ws-F-report): buildPassthroughReAnchor is exported from smPrompts.ts but was never
// imported by the probe, so it had zero golden coverage — net-new fixture pair, not a port.
