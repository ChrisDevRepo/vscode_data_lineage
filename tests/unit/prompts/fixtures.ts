 ...
 *
 * @remarks
 * Values here are captured byte-exact per prompt-builder variant against the real
 * `assets/aiOutputTemplates.yaml`, so the goldens generated from this module (`UPDATE_GOLDEN=1`)
 * stay stable wherever the underlying prompt text has not changed.
 *
