...
// ─── Run all tests ───────────────────────────────────────────────────────────
  ...
  it('analyzes disconnected islands', testIslands);
  it('analyzes graph hubs', testHubs);
  it('analyzes orphan nodes', testOrphans);
  it('analyzes longest paths', testLongestPath);
  it('analyzes cycles', testCycles);
  it('filters subset edges', testSubsetEdgeFiltering);
  it('analyzes external references', testExternalRefs);
});
