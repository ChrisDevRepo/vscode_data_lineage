-- GENERATED SP 67: tier=medium flags=[nestedSubqueries,massiveComments]
-- EXPECT  sources:[hr].[Performance],[dbo].[Shipper],[etl].[BatchControl]  targets:[fin].[CostCenter],[dbo].[Contact]  exec:[dbo].[usp_ReconcilePayments]

CREATE PROCEDURE [ops].[usp_GenMedium_067]
    @BatchID    INT = 0,
...
BEGIN
     ...
     */
    INSERT INTO [fin].[CostCenter] ([ID], [Name])
    SELECT x.[ID], x.[Name]
    FROM (
