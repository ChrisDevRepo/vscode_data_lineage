-- GENERATED SP 179: tier=large flags=[transactionBlocks,printStatements,massiveComments]
-- EXPECT  sources:[dbo].[Department],[stg].[InvoiceStage],[dbo].[Employee],[stg].[OrderStage],[fin].[CostCenter]  targets:[dbo].[Order],[dbo].[Payment],[dbo].[Category]  exec:[etl].[usp_LoadCustomers],[etl].[usp_ValidateStage]

CREATE PROCEDURE [rpt].[usp_GenLarge_179]
    @BatchID    INT = 0,
...
BEGIN
    ...
    JOIN   dbo.Employee AS d ON d.[ID] = a.[ID]
