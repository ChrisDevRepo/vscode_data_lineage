-- GENERATED SP 166: tier=large flags=[nestedSubqueries,tempTableHeavy,allCaps]
-- EXPECT  sources:[dbo].[Department],[stg].[OrderStage],[dbo].[Address],[ops].[PickList]  targets:[hr].[LeaveRequest],[dbo].[Employee]  EXEC:[dbo].[usp_UpdateCustomer],[dbo].[usp_ProcessOrder],[audit].[usp_LogAccess],[etl].[usp_LoadProducts],[hr].[usp_ApproveLeave]

CREATE PROCEDURE [fin].[usp_GenLarge_166]
    @BatchID    INT = 0,
