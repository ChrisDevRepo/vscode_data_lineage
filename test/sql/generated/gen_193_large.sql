-- GENERATED SP 193: tier=large flags=[massiveComments,commentedOutSQL,excessiveDeclare]
-- EXPECT  sources:[hr].[Position],[rpt].[MonthlyOrders],[etl].[BatchControl],[etl].[LoadLog]  targets:[dbo].[Customer],[stg].[CustomerStage],[dbo].[Product]  exec:[rpt].[usp_RefreshSummary],[dbo].[usp_ReconcilePayments]

CREATE PROCEDURE [dbo].[usp_GenLarge_193]
    @BatchID    INT = 0,
