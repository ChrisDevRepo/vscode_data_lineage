-- GENERATED SP 37: tier=tiny flags=[massiveComments]
-- EXPECT  sources:[dbo].[Contact]  targets:[rpt].[MonthlyOrders]  exec:[audit].[usp_LogChange]

CREATE PROCEDURE [hr].[usp_GenTiny_037]
    @BatchID    INT = 0,
