-- GENERATED SP 8: tier=tiny flags=[massiveComments]
-- EXPECT  sources:[ops].[PickList]  targets:[stg].[ProductStage]  exec:[etl].[usp_LoadCustomers]

CREATE PROCEDURE [dbo].[usp_GenTiny_008]
    @BatchID    INT = 0,
