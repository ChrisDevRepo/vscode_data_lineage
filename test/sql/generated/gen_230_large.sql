-- GENERATED SP 230: tier=large flags=[massiveComments,deepTryCatch,excessiveDeclare]
-- EXPECT  sources:[dbo].[Order],[ops].[ReturnOrder],[dbo].[Product],[etl].[BatchControl],[audit].[AccessLog]  targets:[dbo].[Customer],[rpt].[ProductRevenue],[hr].[Position]  exec:[etl].[usp_ValidateStage],[rpt].[usp_RefreshSummary],[etl].[usp_LoadOrders],[dbo].[usp_ArchiveOrders]

CREATE PROCEDURE [rpt].[usp_GenLarge_230]
    @BatchID    INT = 0,
