-- GENERATED SP 305: tier=dmv_style flags=[massiveComments,cursorLoop]
-- EXPECT  sources:[ops].[Inventory]  targets:[stg].[InvoiceStage],[dbo].[Shipper]  exec:[audit].[usp_LogAccess],[etl].[usp_LoadProducts],[dbo].[usp_GenerateInvoice]

SET NOCOUNT ON;

CREATE OR ALTER PROCEDURE [fin].[usp_GenDmv_style_305]
    @BatchID    INT = 0,
