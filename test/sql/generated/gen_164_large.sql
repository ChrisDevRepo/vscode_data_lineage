-- GENERATED SP 164: tier=large flags=[printStatements,massiveComments,noBrackets]
-- EXPECT  sources:[dbo].[Address],[dbo].[Customer],[stg].[CustomerStage],[rpt].[EmployeePerf]  targets:[etl].[BatchControl],[dbo].[Order],[rpt].[RegionMetrics]  exec:[audit].[usp_LogAccess],[etl].[usp_LoadCustomers]

CREATE PROCEDURE [rpt].[usp_GenLarge_164]
    @BatchID    INT = 0,
