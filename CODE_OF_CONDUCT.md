...
interviewing witnesses and other participants. Project maintainers will keep
...
4. **Permanent Ban**
   1. **Event:** A pattern of repeated code of conduct violations that other
      ...
      the project maintainers determine there is no way to keep the community
...
ability of project maintainers to use their discretion and judgment, in keeping
...
version 3.0, permanently available at the [Contributor Covenant 3.0 page][v3.0].
