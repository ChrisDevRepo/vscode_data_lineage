...
npm test         # All tests (342 unit + 80 tsql-complex)
```
...
| `test/tsql-complex.test.ts` | 80 | End-to-end parser corpus: 25 real-world + 55 targeted SQL files; oracle (`-- EXPECT`) and stability-only tests |
