...
import { BOOKMARK_SOURCE_DESCRIPTIONS } from '../engine/shared/bridgeContract';
...
/** Local alias; the contract owns the values. */
const SOURCE_DESCRIPTIONS = BOOKMARK_SOURCE_DESCRIPTIONS;
