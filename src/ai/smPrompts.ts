...
const BLOCK = {
  ...
  routing:
    ...
    'CONSENT GATES: each neighbor carries `in_budget`, `in_user_filter`, and `would_trigger_action_required` flags. Stay within the declared budget and schema filter by default. When the analysis genuinely needs an out-of-bound node, include it in `route_requests` — the engine raises a combined consent gate, the user replies yes/no in chat, and a "yes" caches that schema / depth level for the rest of the session.\n' +
