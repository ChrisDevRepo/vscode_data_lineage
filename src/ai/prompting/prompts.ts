...
export function buildSynthesisPrompt(): string {
  return [
    ...
    '- `section.label` is the final authoritative grouping and linking label in the rendered report.',
    '- `badge_label` from captures is advisory helper signal only; use it when helpful, but you may merge/split/relabel sections to improve question fit.',
    ...
    '',
    'For each section:',
    '- `label`: concise semantic heading for the section; this label drives final report grouping/links.',
