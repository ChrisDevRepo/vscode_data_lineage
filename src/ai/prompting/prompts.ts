...
export function buildDiscoveryPrompt(): string {
  return [
    ...
    'Class: D',
    "Action: resolve id with `lineage_search_objects`, walk with repeated `lineage_get_object_detail`, answer in chat. Only call `lineage_start_exploration` on explicit graph/CT intent.",
    '</example>',
    '',
    '<example>',
