...
const sharedConfig = {
  ...
  format: 'cjs',
  platform: 'node',
  // Tied to `engines.vscode` (^1.101.0): node22 is the oldest runtime this extension can be
  // installed on. Raising `engines.vscode` may allow a newer target; lowering it requires
  // lowering this first.
  target: 'node22',
  sourcemap: true,
  minify: !watch,
